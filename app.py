...
with tab1:
    ...
    st.dataframe(jogadores.set_index("jogadores").sort_values(by='aproveitamento', ascending=False))
...
with tab2:
    ...
    st.dataframe(duplas.set_index("duplas").sort_values(by='aproveitamento', ascending=False))
    st.subheader("Estatíticas dos confrontos")
